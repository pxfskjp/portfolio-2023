      ...
      >
        <div className="flex justify-between items-center mx-auto">
          <div className="flex items-center cursor-pointer">
            ...
            >
              <img src={darkMode ? LogoLight : LogoDark} alt="" style={{height: "70px"}} srcSet="" />
            </a>
          </div>
          <div className="hidden h-[70px] justify-between items-center w-full md:flex md:w-auto ">
            <ul
              className={
                "h-[70px] flex flex-col items-center mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-md md:font-medium"
              }
            >
              {links.map((el, index) => (
                <li key={index} className="cursor-pointer">
                  <Link
                    ...
                    className={
                      darkMode
                        ? "h-[70px] flex justify-center items-center py-2 px-3 text-2xl text-black hover:bg-blue-500 hover:text-white"
                        : "h-[70px] flex justify-center items-center py-2 px-3 text-2xl text-white hover:bg-blue-500 hover:text-black"
                    }
                  >
                    {el.name}
                  </Link>
