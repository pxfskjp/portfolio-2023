...
const Services = () => {
  ...
  return (
    ...
    >
      <div
        className="max-w-7xl mx-auto px-0 pt-20"
        id="services"
      >
        <h2
          className={
          ...
          <div className="mt-8 flex md:flex-row justify-between flex-col md:items-stretch items-center ">
            {serviceData.map((el, index) => (
              <motion.div
                ...
                className={
                  theme.state.darkMode
                    ? "md:w-90 w-1/3 m-2 p-4 bg-white rounded-lg flex items-center flex-col mt-8"
                    : "md:w-90 w-1/3 m-2 p-4 bg-gray-100 rounded-lg flex items-center flex-col mt-8"
                }
              >
                <img src={el.img} alt="" />
